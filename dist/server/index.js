globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/ScionExperience-Go43EqcW.js","assets/layout-segment-context-DqOOS5AR.js"];
...
function getDraftSecret() {
	return "d2b0a0fb-7779-464b-85ae-b384717001d1";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "a65b272f-e557-41a5-90ab-eec21a7fcf96";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "a65b272f-e557-41a5-90ab-eec21a7fcf96") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "a65b272f-e557-41a5-90ab-eec21a7fcf96",
		rootBoundaryId
	});
}
/**
...
var ScionExperience = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ScionExperience' is called on server");
}, "68dee0dcf3ee", "ScionExperience");
//#endregion
//#region app/page.tsx
...
var metadata = {
	title: "Scion FR-S 2015 — история одной машины",
	description: "Кинематографичная история персонального Scion FR-S: Лос-Анджелес, Минск, Санкт-Петербург, возвращение и новая глава."
};
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ScionExperience, {});
}
...
var description = "История Никиты и Scion FR-S 2015: от случайной встречи до покупки на заработок от ИИ-мультфильмов для клиентов из США.";
async function generateMetadata() {
	...
	return {
		...
		title: {
			default: "Scion FR-S 2015 — история одной машины",
			template: "%s · Scion FR-S"
		},
		description,
		icons: {
			icon: "/favicon.png",
		...
		openGraph: {
			...
			locale: "ru_RU",
			url: origin,
			title: "Scion FR-S — мечта, оплаченная нейросетями",
			description,
			images: [{
				url: `${origin}/og.png`,
				width: 1200,
				height: 630,
				alt: "Scion FR-S 2015 — One Car / One Story"
			}]
		},
		twitter: {
...
var __publicFiles = new Set([
	"/favicon.png",
	"/media/README.md",
	"/media/ai-cartoon-01.webp",
	"/media/ai-cartoon-02.webp",
	"/media/ai-cartoon-03.webp",
	"/media/auction-01.webp",
	"/media/auction-02.webp",
	"/media/auction-03.webp",
	"/media/auction-04.webp",
	"/media/autofest-2026.webp",
	"/media/build-01.webp",
	"/media/build-02.webp",
	"/media/current-01.webp",
	"/media/current-02.webp",
	"/media/hero-reference.webp",
	"/media/neurocore-community-logo.png",
	"/media/poster-bottle.webp",
	"/media/poster-gallery-suspended.webp",
	"/media/poster-wet-run.webp",
	"/media/poster-widebody-edition.webp",
	"/media/reference-sheet.webp",
	"/og.png"
]);
